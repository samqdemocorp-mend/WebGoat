...
@RestController
@AssignmentHints(value = {"SqlStringInjectionHint5c1"})
public class SqlInjectionLesson5c extends AssignmentEndpoint {
  ...
  @PostMapping("/SqlInjection/assignment5c")
  @ResponseBody
    ...
    try (Connection connection = dataSource.getConnection()) {
      ...
      try (Statement statement =
        ...
        if ((results != null) && (results.first())) {
          ...
          if (results.getRow() >= 6) {
            return success(this)
                .feedback("sql-injection.5c.success")
          ...
          return failed(this)
              .feedback("sql-injection.5c.no.results")
